...
class NERModel(LanguageModel):
  ...
  def add_embedding(self):
    ...
    #lookup_table = tf.nn.embedding_lookup(self.embeddings, self.input_placeholder)
    #print ("LOOK UP ALRIGHT!!!!!")

    #return tf.reshape(lookup_table, (-1, self.config.window_size * self.config.embed_size))
